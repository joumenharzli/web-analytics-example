 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "application.localization", value = "enabled")
public class LocalizationConfiguration {

  private final ApplicationProperties applicationProperties;

  public LocalizationConfiguration(ApplicationProperties applicationProperties) {
  ...
  public LocaleResolver localeResolver() {
    ...
    localeResolver.setDefaultLocale(applicationProperties.getLocalization().getDefaultLocale());
